...
exports.default = function () {
  var getSuccessAction = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : successActionCb;
  var getErrorAction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : errorActionCb;
  ...
  var middleware = function middleware(store) {
    return function (next) {
      return function (action) {
        ...
        var successAction = getSuccessAction(action);
        var errorAction = getErrorAction(action);
...
var successActionCb = function successActionCb(action) {
  return action[WAIT_FOR_ACTION];
};
var errorActionCb = function errorActionCb(action) {
